...
import { RealDebridProvider } from './realdebrid-provider'
...
describe('RealDebridProvider', () => {
  ...
  beforeEach(() => {
    provider = new RealDebridProvider({ apiToken: 'test-token' })
  })

  describe('constructor', () => {
    it('should create instance with correct name', () => {
      expect(provider.name).toBe('real-debrid')
    })

    it('should throw error without API token', () => {
      expect(() => {
        new RealDebridProvider({ apiToken: '' })
      }).toThrow('Real-Debrid API token is required')
    })
  })
  ...
  describe('startJob', () => {
    ...
    it('should throw error without magnet', async () => {
  ...
  describe('testConnection', () => {
    ...
    it('should fail with invalid token', async () => {
      const invalidProvider = new RealDebridProvider({
